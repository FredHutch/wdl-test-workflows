...
workflow PanelBwaGatk4Annovar {
  input {
    ...
    String annovar_docker = "ghcr.io/getwilds/annovar:hg38" # REPLACE WITH REFNAME!!!
...
task BwaMem {
  ...
  command {
    ...
    samtools view -1bS -@ ~{cpu_needed - 1} -o ~{base_file_name}.aligned.bam ~{base_file_name}.sam
  }
